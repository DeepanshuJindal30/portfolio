export const siteConfig = {
  ...
  badge:
    "SDE-I @ ADP | Full-Stack (React, .NET, Node.js) | Distributed Systems | Agentic AI & LLMs | IEEE-SCOPUS | 2× Patents | LeetCode Guardian (2166) | CodeChef 5★ (2003)",
  subheadline:
    "Software Engineer building scalable full-stack systems, AI agents, and production-ready mobile apps.",
